...
dat_off$weight_logcuberoot = log(dat_off$weight_g^(1/3))
...
off_phen = c("bold_score", "mean_thickness", "weight_logcuberoot", "PC2")
...
I think this all means that the first step is to test the relationship of each variable to size and test whether the relationship is constant over tanks. I think this may have to be done separately for parents and offspring (although it might be nice to test whether the relationship changes...) and maybe also for adults and juveniles.  
...
Taking the cube root of weight returns negative values

```{r tmp1, echo=FALSE, fig.cap="Figure tmp1. Scatter plots of the relationship between size and the other phenotypes in each generation separately.", fig.height=5, fig.width=5, warning=FALSE, dpi=300}
